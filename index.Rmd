...
author: "[By the Student Outreach Committee of MaSA UIUC](https://www.instagram.com/masauiuc)"
...
[`bookdown`](https://bookdown.org/yihui/bookdown/) is a package for the `R` programming language that helps easily create detailed and well-organized books, written in chapters. If you would like to notify us of typos, corrections, or even suggestions as to what we should add content about in this book, you can raise an issue at this [Github](https://github.com/afnanfdz/masa-pre-arrival-booklet){target="_blank"}! 
